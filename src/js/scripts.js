jQuery(document).ready(function($){
  ...
  // ---
  // var cellData =
  // '<div class="cell seed-0">' +
  // '    <p class="team-abreviation" aria-hidden="true">' +
  // '        <a href="javascript:void(0);" data-em="ncaa_bt_team-name"><span class="seed-number">0 </span>?</a>' +
  // '    </p>'+
  // '    <p class="team">'+
  // '        <a href="javascript:void(0);" data-em="ncaa_bt_team-name"><span class="seed-number">0 </span>?</a>' +
  // '    </p>'+
  ...
  function populateEast() {
    ...
    for (i = 0; i < east.length; i++) {
      ...
      if (x.secondRound == true) {
        $('.round-two [class*="-'+ x.seedNumber +'-"] .team-abreviation a').html('<span class="seed-number">' + x.seedNumber + '</span> ' + x.abbreviation).attr({'data-em' : 'ncaa_bt_' + x.schoolName + '_round2', 'title' : 'Shop ' + x.schoolName + '\'s Gear'});
      ...
      if (x.thirdRound == true) {
        $('.round-three [class*="-'+ x.seedNumber +'-"] .team-abreviation a').html('<span class="seed-number">' + x.seedNumber + '</span> ' + x.abbreviation).attr({'data-em' : 'ncaa_bt_' + x.schoolName + '_round3', 'title' : 'Shop ' + x.schoolName + '\'s Gear'});
        $('.round-three [class*="-'+ x.seedNumber +'-"] .team a').html('<span class="seed-number">' + x.seedNumber + '</span> ' + x.schoolName).attr({'data-em' : 'ncaa_bt_' + x.schoolName + '_round3', 'title' : 'Shop ' + x.schoolName + '\'s Gear'});
        if (x.eliminated == true) {
          $('.round-three [class*="-'+  x.seedNumber + '-"]').addClass('eliminated');
        }
      }
      if (x.fourthRound == true) {
        $('.round-four [class*="-'+ x.seedNumber +'-"] .team-abreviation a').html('<span class="seed-number">' + x.seedNumber + '</span> ' + x.abbreviation).attr({'data-em' : 'ncaa_bt_' + x.schoolName + '_round4', 'title' : 'Shop ' + x.schoolName + '\'s Gear'});
        $('.round-four [class*="-'+ x.seedNumber +'-"] .team a').html('<span class="seed-number">' + x.seedNumber + '</span> ' + x.schoolName).attr({'data-em' : 'ncaa_bt_' + x.schoolName + '_round4', 'title' : 'Shop ' + x.schoolName + '\'s Gear'});
        if (x.eliminated == true) {
      ...
      if (x.divisionWinner == true) {
        $('.region-champ-cell .cell .team a').html('<span class="seed-number">' + x.seedNumber + '</span> &nbsp;' + x.schoolName + '&nbsp;').attr({'data-em' : 'ncaa_bt_' + x.schoolName, 'title' : 'Shop ' + x.schoolName + ' Gear'});
      }
      ...
      $('.cell.seed-' + x.seedNumber + ' .team a').html('<span class="seed-number">' + x.seedNumber + '</span> &nbsp;' + x.schoolName + '&nbsp;').attr({'data-em' : 'ncaa_bt_' + x.schoolName, 'title' : 'Shop ' + x.schoolName + ' Gear'});
    }
    contentLoaded();
  }
